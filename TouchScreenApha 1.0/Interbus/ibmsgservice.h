...
signals:
    void sigReceiverStatus(quint8 deviceId, quint8 registerId, quint8 txMsgType, quint8 rxMsgType, QByteArray msgData);

public slots:
    void slotSendMessage(quint8 devId, quint8 regId, quint8 msgType, QByteArray msgData);
