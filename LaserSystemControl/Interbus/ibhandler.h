...
private slots:
    void slotReceiverStatus(quint8 deviceId, quint8 registerId, quint8 txMsgType, quint8 rxMsgType, QByteArray msgData);
...
private:
    ...
    void passRxMessage(quint8 txMsgType, quint8 rxMsgType, QByteArray msgData);
};
